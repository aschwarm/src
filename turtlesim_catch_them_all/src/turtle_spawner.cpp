...
class TurtleSpawnerNode : public rclcpp::Node
{
    public:
        TurtleSpawnerNode() : Node("turtle_spawner"), turtleCounter(0)
        {
            ...
            spawn_timer_ = this->create_wall_timer(std::chrono::duration<double>(2.0), 
                            std::bind(&TurtleSpawnerNode::spawnNewTurtle, this));

            alive_turtle_publisher_ = this->create_publisher<turtle_interfaces::msg::TurtleArray>("alive_turrtles",10);
        }
